...
public class DatabaseTest {
    ...
    @Test
    @DisplayName("DB can insert data")
    public void insert(){
        db.insert(new Product(1, "Coca"));
    ...
    @Test
    @DisplayName("DB can get data")
    public void findById(){
        db.insert(new Product(1, "Coca"));
        db.insert(new Product(2, "gansito"));
        db.insert(new Product(3, "Rancheritos"));
        db.insert(new Product(4, "Donitas"));

        Product p = db.getById(3);


        assertEquals(p.getId(),3);
        assertEquals(p.getName(), "Rancheritos");
    }
